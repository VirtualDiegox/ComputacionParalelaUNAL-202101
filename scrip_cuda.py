...
for imagen in imagenes:
    path = "datacsv/data_cuda_" + imagen + ".csv"
        ...
        for hilos in num_hilos:
            for filtro in filtros:
                if filtro == 1 or filtro == 2:
                    command = "./filtros " + "images/" + imagen + extension + " " + "images_withfilter/" + imagen +"_withfilter"+ str(filtro) +extension + " " +str(filtro) +" "+ str(hilos) +" "+ str(bloques)
                else:
                    command = "./filtros " + "images/" + imagen + extension + " " + "images_withfilter/" + imagen +"_withfilter"+ str(filtro) +extension + " " + str(filtro)+" "+ str(capas) +" "+ str(hilos)+" "+ str(bloques)
